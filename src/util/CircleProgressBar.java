...
public class CircleProgressBar extends JPanel {
	...
	private static CircleProgressBar bar = new CircleProgressBar();
	...
	public void setProgress(int progress) {
		...
		this.setForegroundColor(progress);
		this.repaint();
	...
	public void setForegroundColor(int progress) {
		this.foregroundColor = ColorUtil.getByPercentage(progress);
		this.repaint();
	}
	
	public static CircleProgressBar getIntance() {
		return bar;
	}
